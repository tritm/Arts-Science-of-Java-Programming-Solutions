/**
 * The Rational class is used to represent rational numbers, which are defined to be the quotient of two integer
 */
public class Rational {
    ...
    /**
     * Create a new Rational from the integer argument
    ...
    /**
     * Adds the rational number r to this one and return the sum.
    ...
    /**
     * Miltiplies this number by the rational number r.
